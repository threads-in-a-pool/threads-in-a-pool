$(document).ready(function() {
    ...
    function setEvent(eventId){
        $.ajax({
            url: 'http://94.60.6.212:8080/threadsinapool/api/user/' + eventId + '/tickets',
            async: true,
    ...
    function getUser(userId){
        ...
        $.ajax({
            url: 'http://94.60.6.212:8080/threadsinapool/api/user/' + userId,
            async: true,
    ...
    $(document).on("mousedown touchstart", ".demo__card:not(.inactive)", function(e) {
        ...
        $.ajax({
            url: 'http://94.60.6.212:8080/threadsinapool/api/producer/event/1/list',
            async: true,
            success: successCallback,
            error: function(error) {
                console.log(error);
